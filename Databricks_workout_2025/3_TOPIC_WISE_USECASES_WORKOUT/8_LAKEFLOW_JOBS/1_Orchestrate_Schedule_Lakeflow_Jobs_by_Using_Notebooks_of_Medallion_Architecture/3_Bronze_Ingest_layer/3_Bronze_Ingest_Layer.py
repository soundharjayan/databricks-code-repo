...
staff_df1 = read_file(spark,"csv",f"{SRC}/staff/logistics_source1",True,False,",")
staff_df2 = read_file(spark,"csv",f"{SRC}/staff/logistics_source2",True,False,",")
print(staff_df1.schema)
print(staff_df2.schema)

staff_bronze = mergeDF(staff_df1,staff_df2)

geo_tagging_df= read_csv_df(spark,f"{SRC}/geotag/Master_City_List (1).csv",True,False,",")
print(geo_tagging_df)

shipments_df = read_file(spark,"json",f"{SRC}/shipment/logistics_shipment_detail_3000 (1).json",True)
print(shipments_df)
