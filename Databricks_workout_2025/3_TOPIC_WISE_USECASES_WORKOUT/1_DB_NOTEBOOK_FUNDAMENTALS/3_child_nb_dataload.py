...
# MAGIC %fs
# MAGIC ls /Volumes/workspace/default/mobile_metrics/mobile_os_usage.csv

# COMMAND ----------

# MAGIC %fs head /Volumes/workspace/default/mobile_metrics/mobile_os_usage.csv

# COMMAND ----------

spark.read.csv("/Volumes/workspace/default/mobile_metrics/mobile_os_usage.csv").write.saveAsTable("mobile_os_usage1")

# COMMAND ----------

# MAGIC %matplotlib inline
# MAGIC import pandas as pd
# MAGIC df = pd.read_csv("/Volumes/workspace/default/mobile_metrics/mobile_os_usage.csv")
